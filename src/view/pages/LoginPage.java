...
public class LoginPage extends VBox {
    ...
    private void initializeComponents() {
        ...
        postgradBtn.setOnAction(e -> { matricField.setText("3123456"); passwordField.setText("postgrad123"); loginButton.fire(); });
        studentBtn.setOnAction(e -> { matricField.setText("2123456"); passwordField.setText("student123"); loginButton.fire(); });
        staffBtn.setOnAction(e -> { matricField.setText("1123456"); passwordField.setText("staff123"); loginButton.fire(); });
        adminBtn.setOnAction(e -> { matricField.setText("0123456"); passwordField.setText("admin123"); loginButton.fire(); });
    ...
    private void setupLayout() {
        ...
        Label subtitleLabel = new Label("Please login with your IIUM Matric Number and Password");
        ...
        Label roleDetailsLabel = new Label("0=Admin (admin123) • 1=Staff (staff123) • 2=Student (student123) • 3=Postgraduate (postgrad123)");
    ...
    private void handleLogin() {
        ...
        if (user != null) {
            System.out.println("Login successful for user: " + user.getUserId() + " (Matric: " + user.getMatricNo() + ", Role: " + user.getRole() + ")");
            statusLabel.setVisible(false);
    ...
    // Convenience method for automated tests and quick-login helpers
    public void quickLoginAs(String matric, String password) {
        matricField.setText(matric);
